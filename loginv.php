...
if (isset($_POST['pseudoc']) && isset($_POST['mdpc']) && $_POST['pseudoc'] !== "" && $_POST['mdpc'] !== ""){ // On vérifie si les champs ne sont pas vide
    try
{
    $connect = new PDO('mysql:host=localhost;dbname=chat;charset=utf8', 'root', ''); // On se connecte à la base de donnée via MySQL
}
...
<meta http-equiv="refresh" content="5; URL=login.php"></div>'; // Afficher que les informations sont incorrectes et le V vert
}
else
{
    if ($isPasswordCorrect) {
        ...
        echo '<div class="header"><p>Vous voila connecter ' . $_SESSION['pseudo'] . ' !</p></div>
...
<meta http-equiv="refresh" content="2; URL=chat/">'; // On affiche que l'utilisateur s'est connecté et le V vert
...
<meta http-equiv="refresh" content="5; URL=login.php"></div>'; // On affiche que les informations sont incorrectes et le X rouge
    }
}
}
...
<meta http-equiv="refresh" content="2; URL=login.php">'; // On redirige vers la page de connexion et on affiche le X rouge
}
?>