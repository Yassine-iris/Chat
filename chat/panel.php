...
try
{
    $connect = new PDO('mysql:host=localhost;dbname=chat;charset=utf8', 'root', ''); // On se connecte à la base de donnée
}
...
if(!empty($_POST['envoyer'])) {
    ...
    ?>
    <meta http-equiv="refresh" content="2"; URL="chat/panel.php/"> <!-- Actualiser la page -->
    <?php
}
?>
